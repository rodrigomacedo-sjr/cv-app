...
[The Odin Projec's React course project](https://www.theodinproject.com/lessons/node-path-react-new-cv-application) to exercise basic React concepts.
...
- [ ] Create a simple MVP with the most basic info
  ...
  - [ ] 1 preview/export page
    - [ ] preview
    - [ ] export
- [ ] Make it pretty and responsive
  - [ ] center things
  - [ ] add some color pallete
  - [ ] font
  - [ ] stretch things for desktop?
- [ ] Deploy
- [ ] Maybe improve it to be a bit more realistic at the end
  - [ ] About
  - [ ] Job Description
  - [ ] Projects
  - [ ] Skills
- [ ] Maybe improve it to be a bit prettier at the end
  - [ ] Dark mode
  - [ ] Animations

  This is what I have in mind for the MVP:
  ![MVP Plan](plan.png)

## Live preview

The project is live \[TODO]!

## How to run

**requirements**: A package manager/run time.
